...
// Adapted for Cabinet: pdfjs assets are copied to public/document-editor/pdfjs/
// by scripts/postinstall.mjs and served same-origin.
export const ASSET_BASE = '/document-editor/pdfjs/'
