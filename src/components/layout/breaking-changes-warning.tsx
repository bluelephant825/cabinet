      ...
      <DialogContent className="sm:max-w-xl" showCloseButton={false}>
        ...
        <div className="flex items-center justify-between gap-3 pt-1">
          <p className="text-[11px] text-muted-foreground/70">
            ...
            {" "}Cabinet is an{" "}
            <a href="https://github.com/bluelephant825/cabinet" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 hover:text-foreground">open-source project</a>
            .
          </p>
