...
echo ""
echo "Watch progress:"
echo "  gh run list --limit 1 -R bluelephant825/cabinet"
echo "  gh run watch \$(gh run list --limit 1 -R bluelephant825/cabinet --json databaseId -q '.[0].databaseId')"
echo ""
echo "Verify after completion:"
echo "  npm view create-cabinet version"
echo "  npm view cabinetai version"
echo "  gh release view $TAG -R bluelephant825/cabinet"
